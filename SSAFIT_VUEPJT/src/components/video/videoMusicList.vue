<template>
  <div class="musicContainer">
    <div class="video-box2">
      ...
      <div class="more">
        <RouterLink class="btn-more"
          type="button"
          :to="{ name: 'videoList', params: { videoType: 'music' } }"
          style="font-size: 30px; font-weight: bold;">. . .</RouterLink
        >
      </div>
    </div>  
    </div>
