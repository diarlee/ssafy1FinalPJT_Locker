  ...
  <div class="container">
    <div class="text-wrap fw-bold">
      <div class="btn-container" style="margin-bottom: 5px;">
        ...
        <button class="btn btn-delete" @click="deleteVideo" style="margin-left: 2px;">
    ...
    <div class="review-box shadow rounded bg-light">
      <div v-for="review in reviewStore.reviewList">
        <div class="rv-status">
          <div class="rvId"># {{ review.reviewId }}. {{ review.writer }} 님</div>
        ...
        <div class="rv-content">
          ...
          <div class="btn-cmt">
            <button class="btn btn-rv-update"
              ...
              <button class="btn btn-rv-delete"
